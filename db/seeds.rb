...
event8 = Event.create!(held_at: 19.days.from_now, user: jane, address: "189 Main St. Saint Pete, FL 33713")
...
photo1 = Photo.create!(offered_meal_id: offered_meal8, image: File.open(Rails.root.join("db/seeds/meal8-image.jpg")))
photo2 = Photo.create!(offered_meal_id: offered_meal7, image: File.open(Rails.root.join("db/seeds/meal7-image.jpg")))
photo3 = Photo.create!(offered_meal_id: offered_meal6, image: File.open(Rails.root.join("db/seeds/meal6-image.jpg")))
photo4 = Photo.create!(offered_meal_id: offered_meal5, image: File.open(Rails.root.join("db/seeds/meal5-image.jpg")))
photo5 = Photo.create!(offered_meal_id: offered_meal4, image: File.open(Rails.root.join("db/seeds/meal4-image.jpg")))
photo6 = Photo.create!(offered_meal_id: offered_meal3, image: File.open(Rails.root.join("db/seeds/meal3-image.jpg")))
photo7 = Photo.create!(offered_meal_id: offered_meal2, image: File.open(Rails.root.join("db/seeds/meal2-image.jpg")))
photo8 = Photo.create!(offered_meal_id: offered_meal1, image: File.open(Rails.root.join("db/seeds/meal1-image.jpg")))

rating1 = Rating.create!(meal_selection_id: meal_selection6, stars: 4)
rating2 = Rating.create!(meal_selection_id: meal_selection5, stars: 5)
rating3 = Rating.create!(meal_selection_id: meal_selection4, stars: 4)
rating4 = Rating.create!(meal_selection_id: meal_selection3, stars: 5)
rating5 = Rating.create!(meal_selection_id: meal_selection2, stars: 5)
rating6 = Rating.create!(meal_selection_id: meal_selection1, stars: 4)
